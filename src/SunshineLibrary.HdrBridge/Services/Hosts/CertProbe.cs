...
namespace SunshineLibrary.Services.Hosts
{
    ...
    /// certificate. Used during Add Host to compute the certificate fingerprint the
    ...
    public static class CertProbe
    {
            ...
            using (var linkedCts = CancellationTokenSource.CreateLinkedTokenSource(ct))
            {
                ...
                try
                {
                        ...
                        userCertificateValidationCallback: (_, __, ___, ____) => true))
                    {
                        ...
                        {
                            Success = true,
                            SpkiSha256 = ComputeCertificateSha256(x509),
        ...
        /// the leaf certificate's full DER (<c>RawData</c>).
        /// </summary>
