...
{
    /// <summary>Wire format for Vibeshine GET /api/playnite/games — returns a JSON array directly.</summary>
    public class VibeshinePlayniteGameDto
    {
        [JsonProperty("id")]
        ...
        /// <summary>
        /// Total playtime in minutes. Not yet serialized by Vibeshine's API — field
