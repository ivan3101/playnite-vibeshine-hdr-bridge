...
namespace SunshineLibrary.Models
{
    ...
    public class StreamOverrides
    {
        ...
        /// <summary>Original SunshineLibrary defaults, retained for explicit Auto-mode behavior.</summary>
        ...
        /// <summary>
        /// Runtime baseline used by HDR Bridge. With every field inherited, Moonlight's
        /// saved resolution, FPS, bitrate, codec, frame pacing, audio, and other preferences
        /// remain the source of truth. The Vibeshine category layer later applies only Hdr.
        /// </summary>
        public static StreamOverrides MoonlightInheritedDefault => new StreamOverrides();
    }
}
