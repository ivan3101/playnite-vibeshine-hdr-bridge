...
namespace SunshineLibrary.Settings
{
    ...
    public class GameOverridesWindow
    {
            ...
            HostConfig host = null, RemoteApp app = null)
        {
            ...
            this.effectiveFallback = effectiveFallback ?? StreamOverrides.MoonlightInheritedDefault;
        ...
        private void RefreshPreview()
        {
            ...
            var fullMerged = StreamOverrides.MoonlightInheritedDefault.MergedWith(effectiveFallback.MergedWith(working));
